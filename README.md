...
| [`sealing/`](sealing/) | The at-rest / PII protection primitives: libsodium **sealed boxes**, an **HMAC-SHA256 blind index**, **AES-256-GCM**, and digest helpers. Source-for-visibility — see [`sealing/README.md`](sealing/README.md); these files are **not** standalone-buildable. |
...
harvest-now-decrypt-later risk (KEM) and future signature forgery (signatures). The at-rest / PII
layer (`sealing/`) adds libsodium sealed boxes and an HMAC blind index.
...
| ML-DSA-87 (signatures) | MLS messaging | [FIPS 204](https://csrc.nist.gov/pubs/fips/204/final) (NIST PQC) |
| AES-256-GCM | MLS AEAD · blob store | FIPS 197 / NIST SP 800-38D |
| SHA-384 / SHA-256 | MLS KDF · digests | FIPS 180-4 |
...
| Ed25519 | root identity / device-cert signing | [RFC 8032](https://www.rfc-editor.org/rfc/rfc8032) |
